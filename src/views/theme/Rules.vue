            ...
            <CRow>
              <CCol sm="6">
                <CInput v-model="KeywordName"
                  label="KeywordName"
                  placeholder="KeywordName"
                />
              </CCol>
              <CCol sm="6">
                <CInput v-model="SchedulerName"
                  label="SchedulerName"
                  placeholder="SchedulerName"
                />
              </CCol>
            </CRow>
<!--            <CRow>-->
...
export default {
  ...
  methods: {
    ...
    insertSite: function() {
      axios.post('https://7g3u095i99.execute-api.us-east-1.amazonaws.com/product/rule', {
    ...
    getRuleList () {
      ...
      for (let i= 0;i<=this.toDoItems.length -1;i++) {
        arr.push(
            { rulename : this.toDoItems[i][0],
              sitename : this.toDoItems[i][1],
              keywordname : this.toDoItems[i][2],
