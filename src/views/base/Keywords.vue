...
export default {
  ...
  // },
  created () {           // 초기화 함수를 정의 한다.
    axios.get('https://7g3u095i99.execute-api.us-east-1.amazonaws.com/product/keywords')
      .then(response =>  {
  ...
  methods: {
    ...
    insertSite: function() {
      axios.post('https://7g3u095i99.execute-api.us-east-1.amazonaws.com/product/keyword', {
